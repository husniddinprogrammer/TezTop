...
public class TezTopApplication implements ApplicationRunner {

	public static void main(String[] args) {
		SpringApplication.run(TezTopApplication.class, args);
	}
	@Autowired
	JwtUtil jwtUtil;
