...
public class Mijoz {
    ...
    private User tegishliOdam;
    public Mijoz(){};

    public Mijoz(Long id, String ism, String nomer, String izoh, Integer status, LocalDateTime qushilganVaqt, User tegishliOdam) {
        this.id = id;
        this.ism = ism;
        this.nomer = nomer;
        this.izoh = izoh;
        ...
        this.tegishliOdam = tegishliOdam;
    }
    ...
    public User getTegishliOdam() {
        return tegishliOdam;
    }

    public void setTegishliOdam(User tegishliOdam) {
        this.tegishliOdam = tegishliOdam;
    }
}
