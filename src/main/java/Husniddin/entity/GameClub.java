...
public class GameClub {
    ...
    public GameClub(Long id, String nomi, Integer narxi, String manzil, Integer status, String googleMap, String koordinataX, String koordinataY, User boshliq, User admin, MaydonTuri maydonTuri, Long oqilgan, Long oqilganIchi, Fayl photo1, Fayl photo2, String starWork, String finishWork, Boolean open, Integer soni, Integer boshSoni, Integer bandSoni) {
        this.id = id;
        this.nomi = nomi;
        this.narxi = narxi;
        this.manzil = manzil;
