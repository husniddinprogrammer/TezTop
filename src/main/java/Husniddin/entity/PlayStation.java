...
public class PlayStation {
    ...
    private Boolean soniKursat;
    private Integer boshSoni;
    private Integer bandSoni;
    public PlayStation() {
    }

    public PlayStation(Long id, String nomi, Integer narxi, String manzil, Integer status, String googleMap, String koordinataX, String koordinataY, User boshliq, User admin, MaydonTuri maydonTuri, Long oqilgan, Long oqilganIchi, Fayl photo1, Fayl photo2, String starWork, String finishWork, Boolean open, Integer soni, Boolean soniKursat, Integer boshSoni, Integer bandSoni) {
        this.id = id;
        this.nomi = nomi;
        this.narxi = narxi;
        this.manzil = manzil;
        ...
        this.open = open;
        this.soni = soni;
        this.soniKursat = soniKursat;
        this.boshSoni = boshSoni;
        this.bandSoni = bandSoni;
    }
    ...
    public Boolean getSoniKursat() {
        return soniKursat;
    }

    public void setSoniKursat(Boolean soniKursat) {
        this.soniKursat = soniKursat;
    }

    public Integer getBoshSoni() {
        return boshSoni;
    }

    public void setBoshSoni(Integer boshSoni) {
        this.boshSoni = boshSoni;
    }

    public Integer getBandSoni() {
        return bandSoni;
    }

    public void setBandSoni(Integer bandSoni) {
        this.bandSoni = bandSoni;
    }
}
