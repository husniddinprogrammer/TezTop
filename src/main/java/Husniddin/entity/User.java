...
import Husniddin.configuration.Constants;
...
public class User implements Serializable {
    ...
    public User(Long id, @Pattern(regexp = Constants.LOGIN_REGEX) @Size(min = 6, max = 30) String username, @Size(min = 6, max = 60) String password, String name, String number, LocalDateTime qushilganVaqti, Long aktiv, Set<Lavozim> lavozimlar, MaydonTuri maydonTuri) {
        this.id = id;
